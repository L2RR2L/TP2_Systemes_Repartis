...
public class Application {
    private static final String path = "src/main/java/BO2/Commands.txt";
    private static final String url = "jdbc:postgresql://localhost:5433/bo2-database";
    private static final String user = "bo2-database";
    private static final String password = "bo2-database-password";
